...
//     element.InnerText(`${simpson.name} ${simpson.surname} ${simpson.age}`)
...
//
// let element = createElement('div')
// let divName.InnerText = simpson.name
//
// let element = createElement('div')
// let divSurname.InnerText = simpson.surname
//
// let element = createElement('div')
// let divAge.InnerText = simpson.age
//
// let element = createElement('p')
// let divInfo.InnerText = simpson.info
//
// let element = createElement('img')
// let divPhoto.InnerText = simpson.photo
//
// element.appendChind(divName)
// element.appendChild(divSurname)
// element.appendChild(divAge)
// element.appendChild(divInfo)
// element.appendChild(divPhoto)
...
for(const item of coursesArray){
   ...
   titleElement.innerText = item.title
    ...
    for(const el of item.modules){
        let l  = document.createElement('li')
        l.innerText = el
        modules.appendChild(l)
    }
    courseElement.append(modules,titleElement,monthDuration,hourDuration)
