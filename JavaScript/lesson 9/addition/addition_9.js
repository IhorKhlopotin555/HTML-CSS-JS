...
for(const user of usersList) {
    ...
    for (const el in user.addressElement) {
        ...
        suite.innerText = el
        addressElement.appendChild(suite)
        ...
        zipcode.innerText = el
        addressElement.appendChild(zipcode)

        let geoElement = document.createElement('li')
        geoElement.innerText = addressElement.geo
        addressElement.appendChild(geoElement)

        for (const elem in user.geoElement) {
            let lat = document.createElement('li')
            lat.innerText = elem
            geoElement.appendChild(lat)

            let lng = document.createElement('li')
            lng.innerText = elem
            geoElement.appendChild(lng)
        }
    }
    ...
    companyElement.innerText = user.company

    for (const element in user.companyElement) {

    let name = document.createElement('li')
        name.innerText = element
        addressElement.appendChild(name)

        let catchPhrase = document.createElement('li')
        catchPhrase.innerText = element
        addressElement.appendChild(catchPhrase)

        let bs = document.createElement('li')
        bs.innerText = element
        addressElement.appendChild(bs)
    }
    userElement.append(idElement, nameElement, usernameElement, emailElement, addressElement, phoneElement, websiteElement, companyElement)
